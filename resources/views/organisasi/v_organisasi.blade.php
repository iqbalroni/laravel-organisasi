            ...
            @foreach ($organisasi as $row)
                        @if ($row->level == 2)
                            <tr>
                                ...
                                <td>
                                      <a href="/organisasi/detail/{{$row->id}}" class="btn m-1 btn-dark"><i class="fa fa-chevron-right"></i></a>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body text-center">
              <p class="lead">Organisasi {{$row->name}} dan anggota {{$row->name}} ingin di hapus?</p>
            </div>
